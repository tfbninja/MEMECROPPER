...
To sync your phone files with google drive, I use [AutoSync](https://play.google.com/store/apps/details?id=com.ttxapps.autosync&hl=en_US&gl=US), I believe you can find it on the play store, idk about apple tho. (~~As if apple users would want to program anyway~~ if you have an ios device I'm sure you can find something [:)](https://xkcd.com/541/)) 
